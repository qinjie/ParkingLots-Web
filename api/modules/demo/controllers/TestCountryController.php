...
use api\modules\demo\models\TestCountry;
...
class TestCountryController extends ActiveController
{
    public $modelClass = 'api\modules\demo\models\TestCountry';
    ...
    public function behaviors()
    {
        ...
        $behaviors['authenticator'] = [
            ...
            'except' => ['view', 'index', 'public-hello'],
            'authMethods' => [
        ...
        $behaviors['access'] = [
            ...
            'rules' => [
                [
                    ...
                    'actions' => ['view', 'index', 'public-hello'],
                    'allow' => true,
                    'roles' => ['?', '@'],
                ],
//                [
...
//        ];
    ...
    public function actionPublicHello()
    {
        return [
